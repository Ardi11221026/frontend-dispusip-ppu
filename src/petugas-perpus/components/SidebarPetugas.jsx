...
export default function SidebarPetugas({ activeMenu, open, onClose, onLogout, setActiveMenu, setOpen }) {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-40 w-72 transform bg-gradient-to-b from-emerald-700 via-emerald-800 to-emerald-950 text-white transition-transform duration-300 ease-in-out md:sticky md:top-0 md:h-screen md:translate-x-0 ${
